    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                # print(f"The distance is {distance_from_circle}")
        ...
        # Done 6: Create a caption (render the text) based on the message_text with the color (122, 237, 201)
        ...
        screen.blit(caption, (25, screen.get_height() - 50))
