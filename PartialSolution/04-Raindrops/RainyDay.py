...
class Cloud:
    ...
    def rain(self):
        ...
        new_drop = Raindrop(self.screen, random.randint(self.x, self.x + self.image.get_width()),
...
def main():
    ...
    while True:
        ...
        if pressed_keys[pygame.K_RIGHT]:
            cloud.x = cloud.x + 10
            if cloud.x + cloud.image.get_width() > screen.get_width():
                cloud.x = screen.get_width() - cloud.image.get_width()
