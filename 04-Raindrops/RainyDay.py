...
class Raindrop:
    ...
    def draw(self):
        ...
        pygame.draw.line(self.screen, (0, 0, 250), (self.x, self.y), (self.x, self.y - 5), 2)
...
class Hero:
    ...
    def hit_by(self, raindrop):
        ...
        hit_box = pygame.Rect(self.x, self.y, self.image_with_umbrella.get_width(), self.image_without_umbrella.get_height())
        # hit_box = pygame.Rect(self.x, self.y, 170, 192)
...
def main():
    ...
    #  15: Make a Hero, named mike, with appropriate images, starting at position x=200 y=400.
    #  15: Make a Hero, named alyssa, with appropriate images, starting at position x=700 y=400.
    ...
    while True:
        ...
        # --- Begin test_drop code that will be removed later...
        ...
        #  20: As a temporary test, check if test_drop is hitting Mike (or Alyssa), if so set their last_hit_time
        ...
        # --- End test_drop code that will be removed later.
        ...
        #     For each Raindrop in the Cloud's list of raindrops:
            #       - move the Raindrop.
            #       - draw the Raindrop.
            #   30: if the Hero (Mike or Alyssa) is hit by a Raindrop, set the Hero's last_time_hit to the current time.
        ...
        #  18: Draw the Heroes (Mike and Alyssa)
        mike.draw()
        alyssa.draw()
