...
class ViewController:
    ...
    def check_event(self, event):
        ...
        if event.type == pygame.MOUSEBUTTONUP:
            # self.game.take_turn(get_row_col(event.pos))
...
def main():
    ...
    # print(view_controller.game)  # turn 0, X's turn, ... ... ...
    #
    # view_controller.game.take_turn(1, 2)
    # print(view_controller.game)  # turn 1, O's turn, ... ..X ...
    #
    # view_controller.game.take_turn(1, 1)
    # print(view_controller.game)  # turn 2, X's turn, ... .OX ...
    #
    # view_controller.game.take_turn(0, 2)
    # print(view_controller.game)  # turn 3, O's turn, ..X .OX ...
    #
    # view_controller.game.take_turn(2, 1)
    # print(view_controller.game)  # turn 4, X's turn, ..X .OX .O.
    #
    # view_controller.game.take_turn(2, 2)
    # print(view_controller.game)  # turn 5, X's Wins!, ..X .OX .OX
